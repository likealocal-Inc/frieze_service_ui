    ...
    <>
      <div className='bg-[#F5F6FA] w-[390px] h-[844px] ml-[-8px] mt-[-8px]'>
        ...
        <div className='flex flex-col items-center justify-center'>
          <Image src={"/img/check_icon.svg"} width={56} height={56} alt='' />
          ...
          <div className='mt-[-100px] z-50'>
            ...
            <div className='flex flex-col text-white mt-[-60px] items-center font-sans text-[13px]'>
              <div className='flex '>
                ...
                <div className='ml-[2px] font-bold'>dispatch information</div>
              </div>
              <div className='mt-[3px]' />
              <div className=''>will be provided through the chat room!</div>
            </div>
          </div>
        </div>
      </div>
